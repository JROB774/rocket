...
int main(int argc, char** argv)
{
    ...
    if(!gladLoadGLLoader(SDL_GL_GetProcAddress)) CS_ERROR_LOG("Failed to load OpenGL procs!");
    ...
    while(s_appConfig.app->m_running)
    {
        ...
        if(CS_CHECK_FLAGS(io.ConfigFlags, ImGuiConfigFlags_ViewportsEnable))
        {
