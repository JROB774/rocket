...
static void ImGui_ImplSDL2_UpdateMouseCursor()
{
    ...
    // We have commented this out becuase it interferes with our ability to show/hide the mouse cursor due
    // to this ImGui platform implementation resetting the cursor to visible each frame. We might want a
    // better way of handling this but what would be preferable is not having to edit this implementation
    // at all as this could lead to issues (e.g. updating the source and not remembering this change).
    // - Josh, May 25th 2021
